...
public class ArticleController {
	...
	@GetMapping("/findArticleByCatégorie/{cat}")
	public List<Article> findArticleByCatégorie(@PathVariable String cat) {
		return articleServiceImpl.findArticleByCatégorie(cat);
	}
