...
public class EvaluationController {
	...
	@GetMapping("/findEvaluationByIdEL/{idEleve}")
	public List<Evaluation> findEvaluationByIdEl(@PathVariable Long idEleve) {
		return evaluationServiceImpl.findEvaluationByIdEl(idEleve);
	}
	...
	@DeleteMapping("/deleteEvaluationById/{id}")
	public void deleteEvaluationById(@PathVariable Long id) {
		evaluationServiceImpl.deleteEvaluationById(id);
	}
